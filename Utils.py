...
#import theano_dir.logistic_sgd_2
...
class Utils:
    ...
    @staticmethod
    def readFileShuffleInstancesBalanced(fileName):
        fileLines = [line.strip() for line in open(fileName)]
        fileList = []
        instancesList = []
        classInstances = []
        ...
        for fileLine in fileLines:
            if fileLine.startswith("@"):
                ...
                lineList = fileLine.split(",")
                nextLabel = lineList[-1]
                if currLabel != nextLabel:
                    if len(classInstances) != 0:
                        instancesList.append(classInstances)
                    classInstances = []
                    currLabel = nextLabel

                classInstances.append(lineList)
                #instancesList.append(lineList) # list of lists

        # last class instances
        instancesList.append(classInstances)
        #random.shuffle(instancesList) # important for the training and validation sets to train a better DL model
        #random.shuffle(instancesList)

        instancesListBalancedShuffle = Utils.shuffleBalanced(instancesList)

        for instance in instancesListBalancedShuffle:
            fileList.append(",".join(instance))

        return fileList

    @staticmethod
    def shuffleBalanced(instancesList):
        numClasses = len(instancesList)
        numInstancesPerClass = len(instancesList[0])
        newShuffle = []

        for j in range(0, numInstancesPerClass):
            for i in range(0, numClasses):
                try:
                    newShuffle.append(instancesList[i][j])
                except:
...
#
    ...
    def joinTrainingTestingFiles(trainFileName, testFileName):
        ...
        for line in testFileLines: # as classes have mon and nonMon, in case of open world
            if line[0] == '@':
...
#Utils.calcTreeBaseRF(['/data/kld/temp/Website-Fingerprinting-Glove/WF-BiDirection-PCA-Glove-OSAD-11Nov2015/cache/datafile-47yhu0bp-rf-train.arff','/data/kld/temp/Website-Fingerprinting-Glove/WF-BiDirection-PCA-Glove-OSAD-11Nov2015/cache/datafile-47yhu0bp-rf-test.arff'],1)
    ...
    def intToDL(n):
        ...
        :param n:
        :return: Deep Learning method
        """
        DLMethod = None
        if n == 1:
            DLMethod = '' #logistic_sgd_2
        elif n == 1:
            DLMethod = '' #dA_2
    ...
    def tsne2(files):
        ...
        for line in trainList:
            if line[0] == '@':
                ...
                num = int(line.split(",")[-1].split("webpage")[1]) # take the id of the webpage (int)
                if (num <= 11):
                    label = 0 # benign
                else:
                    label = 1 # attack

                train_y.append(label)  # take the id of the webpage (int)
        ...
        for line in testList:
            if line[0] != '@':
                ...
                test_y.append(label)  # take the id of the webpage (int)
        ...
        X_tsne = TSNE(learning_rate=100).fit_transform(train_test_X)
        X_pca = PCA().fit_transform(train_test_X)

        plt.figure(figsize=(10, 5))
        plt.subplot(121)
        plt.scatter(X_tsne[:, 0], X_tsne[:, 1], c=train_test_y)
        plt.subplot(122)
        plt.scatter(X_pca[:, 0], X_pca[:, 1], c=train_test_y)
        plt.show()

    # one benign (number 0)  and one attack (number 12
    @staticmethod
    def tsne3(files):
        import matplotlib.pyplot as plt
        from sklearn.manifold import TSNE
        ...
        plt.subplot(121)
        plt.scatter(X_tsne[:, 0], X_tsne[:, 1], c=train_test_y)
        #plt.legend(loc = 0, scatterpoints = 1, label=train_test_y)
    ...
    def tsne4(files):
        ...
        plt.subplot(121)
        #plt.scatter(X_tsne[:, 0], X_tsne[:, 1], c=train_test_y)
        x = X_tsne[:, 0] # dimension 1
        y = X_tsne[:, 1] # dimension 2
        unique = list(set(train_test_y))
        colors = [plt.cm.jet(float(i) / max(unique)) for i in unique]
        for i, u in enumerate(unique):
            xi = [x[j] for j in range(len(x)) if train_test_y[j] == u]
            yi = [y[j] for j in range(len(x)) if train_test_y[j] == u]

            plt.scatter(xi, yi, c=colors[i], label="Benign" if u == 0 else "Attack")
...
#Utils.tsne()
#fileTrain = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/PadToMTU/morphingConstant1/code/cache/datafile-1mdsgn9vk28.c1.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-train.arff"
#fileTest = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/PadToMTU/morphingConstant1/code/cache/datafile-1mdsgn9vk28.c1.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-test.arff"

# all morphed in training
#fileTrain = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant1/code/cache/datafile-5rbjtp3kk28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-train.arff"
#fileTest = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant1/code/cache/datafile-5rbjtp3kk28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-test.arff"

# none morphed in training
#fileTrain = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant101_noMorphInTrain/code/cache/datafile-5ymi0cs3k28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-train.arff"
#fileTest = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant101_noMorphInTrain/code/cache/datafile-5ymi0cs3k28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-test.arff"

# 25% morphed
#fileTrain = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant4/code/cache/datafile-6fis0grck28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-train.arff"
#fileTest = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant4/code/cache/datafile-6fis0grck28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-test.arff"

# 50% morphed
#fileTrain = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant2/code/cache/datafile-2k7bdiu1k28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-train.arff"
#fileTest = "/data/kld/papers/000Experiments_Hp_IDS_CCS17/DefensesAdaptiveMorphing/TM/morphingConstant2/code/cache/datafile-2k7bdiu1k28.c9.d64.C23.N29.t100.T100.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600.u200.Q16.w16.W16-test.arff"

#files = [fileTrain, fileTest]

#Utils.tsne2(files)
#Utils.tsne3(files)
#Utils.tsne4(files) # used for the ccs17 paper
'''
